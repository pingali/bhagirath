...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticMicrotask.status_flag'
        db.add_column('translation_staticmicrotask', 'status_flag', self.gf('django.db.models.fields.CharField')(default='Circulate', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticMicrotask.status_flag'
        db.delete_column('translation_staticmicrotask', 'status_flag')
