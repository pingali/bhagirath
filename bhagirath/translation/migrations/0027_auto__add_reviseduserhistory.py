...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RevisedUserHistory'
        db.create_table('translation_reviseduserhistory', (
            ...
            ('correction_episode', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal('translation', ['RevisedUserHistory'])


    def backwards(self, orm):
        
        # Deleting model 'RevisedUserHistory'
        db.delete_table('translation_reviseduserhistory')
