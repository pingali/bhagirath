...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.no_of_perfect_translations'
        db.add_column('translation_userprofile', 'no_of_perfect_translations', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'StaticMicrotask.user'
        db.add_column('translation_staticmicrotask', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.no_of_perfect_translations'
        db.delete_column('translation_userprofile', 'no_of_perfect_translations')

        # Deleting field 'StaticMicrotask.user'
        db.delete_column('translation_staticmicrotask', 'user_id')
