...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserHistory.microtask'
        db.delete_column('translation_userhistory', 'microtask_id')


    def backwards(self, orm):
        
        # Adding field 'UserHistory.microtask'
        db.add_column('translation_userhistory', 'microtask', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['translation.Microtask'], null=True), keep_default=False)
