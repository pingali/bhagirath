...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Master_English2Hindi', fields ['english_word']
        db.delete_unique('translation_master_english2hindi', ['english_word'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Master_English2Hindi', fields ['english_word']
        db.create_unique('translation_master_english2hindi', ['english_word'])
