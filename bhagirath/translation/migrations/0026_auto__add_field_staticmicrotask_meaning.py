...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticMicrotask.meaning'
        db.add_column('translation_staticmicrotask', 'meaning', self.gf('jsonfield.fields.JSONField')(default=[{}]), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticMicrotask.meaning'
        db.delete_column('translation_staticmicrotask', 'meaning')
