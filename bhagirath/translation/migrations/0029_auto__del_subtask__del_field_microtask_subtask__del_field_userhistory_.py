...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Microtask.subtask'
        db.delete_column('translation_microtask', 'subtask_id')

        # Deleting field 'UserHistory.subtask'
        db.delete_column('translation_userhistory', 'subtask_id')

        # Deleting field 'RevisedUserHistory.subtask'
        db.delete_column('translation_reviseduserhistory', 'subtask_id')

        # Deleting field 'StaticMicrotask.subtask'
        db.delete_column('translation_staticmicrotask', 'subtask_id')

        # Deleting field 'TransactionAction.subtask'
        db.delete_column('translation_transactionaction', 'subtask_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Microtask.subtask'
        db.add_column('translation_microtask', 'subtask', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['translation.Subtask']), keep_default=False)

        # Adding field 'UserHistory.subtask'
        db.add_column('translation_userhistory', 'subtask', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['translation.Subtask']), keep_default=False)

        # Adding field 'RevisedUserHistory.subtask'
        db.add_column('translation_reviseduserhistory', 'subtask', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['translation.Subtask']), keep_default=False)

        # Adding field 'StaticMicrotask.subtask'
        db.add_column('translation_staticmicrotask', 'subtask', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['translation.Subtask']), keep_default=False)

        # Adding field 'TransactionAction.subtask'
        db.add_column('translation_transactionaction', 'subtask', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['translation.Subtask'], null=True), keep_default=False)
