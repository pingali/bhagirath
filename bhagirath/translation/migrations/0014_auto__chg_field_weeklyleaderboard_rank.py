...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'WeeklyLeaderboard.rank' to match new field type.
        db.rename_column('translation_weeklyleaderboard', 'rank', 'rank_id')
        # Changing field 'WeeklyLeaderboard.rank'
        db.alter_column('translation_weeklyleaderboard', 'rank_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['translation.OverallLeaderboard']))

        # Adding index on 'WeeklyLeaderboard', fields ['rank']
        db.create_index('translation_weeklyleaderboard', ['rank_id'])


    def backwards(self, orm):
        
        # Removing index on 'WeeklyLeaderboard', fields ['rank']
        db.delete_index('translation_weeklyleaderboard', ['rank_id'])

        # Renaming column for 'WeeklyLeaderboard.rank' to match new field type.
        db.rename_column('translation_weeklyleaderboard', 'rank_id', 'rank')
        # Changing field 'WeeklyLeaderboard.rank'
        db.alter_column('translation_weeklyleaderboard', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True))
