...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaticMicrotask.translations_received'
        db.add_column('translation_staticmicrotask', 'translations_received', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'StaticMicrotask.translation_requests_sent'
        db.add_column('translation_staticmicrotask', 'translation_requests_sent', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StaticMicrotask.translations_received'
        db.delete_column('translation_staticmicrotask', 'translations_received')

        # Deleting field 'StaticMicrotask.translation_requests_sent'
        db.delete_column('translation_staticmicrotask', 'translation_requests_sent')
