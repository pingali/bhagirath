...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Microtask.assigned'
        db.alter_column('translation_microtask', 'assigned', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserHistory.change_flag'
        db.alter_column('translation_userhistory', 'change_flag', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserHistory.current_active_tag'
        db.alter_column('translation_userhistory', 'current_active_tag', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.translator'
        db.alter_column('translation_userprofile', 'translator', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.contributor'
        db.alter_column('translation_userprofile', 'contributor', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.evaluator'
        db.alter_column('translation_userprofile', 'evaluator', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Master_InterestTags.need_evaluation'
        db.alter_column('translation_master_interesttags', 'need_evaluation', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'StaticMicrotask.scoring_done'
        db.alter_column('translation_staticmicrotask', 'scoring_done', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'StaticMicrotask.assigned'
        db.alter_column('translation_staticmicrotask', 'assigned', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Task.published'
        db.alter_column('translation_task', 'published', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Subtask.assigned'
        db.alter_column('translation_subtask', 'assigned', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Microtask.assigned'
        db.alter_column('translation_microtask', 'assigned', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserHistory.change_flag'
        db.alter_column('translation_userhistory', 'change_flag', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserHistory.current_active_tag'
        db.alter_column('translation_userhistory', 'current_active_tag', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.translator'
        db.alter_column('translation_userprofile', 'translator', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.contributor'
        db.alter_column('translation_userprofile', 'contributor', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.evaluator'
        db.alter_column('translation_userprofile', 'evaluator', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Master_InterestTags.need_evaluation'
        db.alter_column('translation_master_interesttags', 'need_evaluation', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StaticMicrotask.scoring_done'
        db.alter_column('translation_staticmicrotask', 'scoring_done', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StaticMicrotask.assigned'
        db.alter_column('translation_staticmicrotask', 'assigned', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Task.published'
        db.alter_column('translation_task', 'published', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Subtask.assigned'
        db.alter_column('translation_subtask', 'assigned', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'translation.master_interesttags': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'need_evaluation': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        ...
        'translation.staticmicrotask': {
            ...
            'original_sentence': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'scoring_done': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'translation.userhistory': {
            ...
            'change_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'correction_episode': ('jsonfield.fields.JSONField', [], {}),
            'current_active_tag': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'translation.userprofile': {
            ...
            'evaluator': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'translator': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
