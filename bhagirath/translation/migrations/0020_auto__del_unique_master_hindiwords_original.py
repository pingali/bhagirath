...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Master_HindiWords', fields ['original']
        db.delete_unique('translation_master_hindiwords', ['original'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Master_HindiWords', fields ['original']
        db.create_unique('translation_master_hindiwords', ['original'])
