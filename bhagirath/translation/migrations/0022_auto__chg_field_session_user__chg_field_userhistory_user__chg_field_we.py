...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('translation_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'UserHistory.user'
        db.alter_column('translation_userhistory', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'WeeklyLeaderboard.username'
        db.alter_column('translation_weeklyleaderboard', 'username_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'OverallLeaderboard.username'
        db.alter_column('translation_overallleaderboard', 'username_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'TransactionAction.user'
        db.alter_column('translation_transactionaction', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Task.user'
        db.alter_column('translation_task', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Session.user'
        db.alter_column('translation_session', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'UserHistory.user'
        db.alter_column('translation_userhistory', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'WeeklyLeaderboard.username'
        db.alter_column('translation_weeklyleaderboard', 'username_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'OverallLeaderboard.username'
        db.alter_column('translation_overallleaderboard', 'username_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'TransactionAction.user'
        db.alter_column('translation_transactionaction', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Task.user'
        db.alter_column('translation_task', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
