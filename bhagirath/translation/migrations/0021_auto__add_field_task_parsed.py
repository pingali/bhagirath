...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.parsed'
        db.add_column('translation_task', 'parsed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.parsed'
        db.delete_column('translation_task', 'parsed')
