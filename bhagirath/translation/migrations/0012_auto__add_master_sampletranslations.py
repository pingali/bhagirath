...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Master_SampleTranslations'
        db.create_table('translation_master_sampletranslations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_sentence', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('google_translation', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('user_translation', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal('translation', ['Master_SampleTranslations'])


    def backwards(self, orm):
        
        # Deleting model 'Master_SampleTranslations'
        db.delete_table('translation_master_sampletranslations')
