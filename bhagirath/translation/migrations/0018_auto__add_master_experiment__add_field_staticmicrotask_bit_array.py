...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Master_Experiment'
        db.create_table('translation_master_experiment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bit_array', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('translation', ['Master_Experiment'])

        # Adding field 'StaticMicrotask.bit_array'
        db.add_column('translation_staticmicrotask', 'bit_array', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['translation.Master_Experiment'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Master_Experiment'
        db.delete_table('translation_master_experiment')

        # Deleting field 'StaticMicrotask.bit_array'
        db.delete_column('translation_staticmicrotask', 'bit_array_id')
    ...
    models = {
        ...
        'translation.master_experiment': {
            ...
            'bit_array': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
