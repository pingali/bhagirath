...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('translation_userprofile', 'district', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['translation.Master_GeographicalRegion'], null=True), keep_default=False)

        # Adding field 'UserProfile.education_qualification'
        db.add_column('translation_userprofile', 'education_qualification', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'UserProfile.medium_of_education_during_school'
        db.add_column('translation_userprofile', 'medium_of_education_during_school', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='translation_userprofile_related_medium_of_education', null=True, blank=True, to=orm['translation.Master_Language']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('translation_userprofile', 'district_id')

        # Deleting field 'UserProfile.education_qualification'
        db.delete_column('translation_userprofile', 'education_qualification')

        # Deleting field 'UserProfile.medium_of_education_during_school'
        db.delete_column('translation_userprofile', 'medium_of_education_during_school_id')
    ...
    models = {
        ...
        'translation.userprofile': {
            ...
            'education_qualification': ('django.db.models.fields.TextField', [], {'null': 'True'}),
