...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Master_EducationDomain.education_qualification'
        db.delete_column('translation_master_educationdomain', 'education_qualification_id')


    def backwards(self, orm):
        
        # Adding field 'Master_EducationDomain.education_qualification'
        db.add_column('translation_master_educationdomain', 'education_qualification', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['translation.Master_EducationQualification']), keep_default=False)
