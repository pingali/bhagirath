...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserHistory.transliterated_sentence'
        db.delete_column('translation_userhistory', 'transliterated_sentence')

        # Adding field 'UserHistory.correction_episode'
        db.add_column('translation_userhistory', 'correction_episode', self.gf('jsonfield.fields.JSONField')(default=None), keep_default=False)

        # Deleting field 'StaticMicrotask.transliterated_sentence'
        db.delete_column('translation_staticmicrotask', 'transliterated_sentence')

        # Deleting field 'Master_HindiWords.transliterated'
        db.delete_column('translation_master_hindiwords', 'transliterated')


    def backwards(self, orm):
        
        # Adding field 'UserHistory.transliterated_sentence'
        db.add_column('translation_userhistory', 'transliterated_sentence', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True), keep_default=False)

        # Deleting field 'UserHistory.correction_episode'
        db.delete_column('translation_userhistory', 'correction_episode')

        # Adding field 'StaticMicrotask.transliterated_sentence'
        db.add_column('translation_staticmicrotask', 'transliterated_sentence', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True), keep_default=False)

        # Adding field 'Master_HindiWords.transliterated'
        db.add_column('translation_master_hindiwords', 'transliterated', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True), keep_default=False)
    ...
    models = {
        ...
        'translation.userprofile': {
            ...
            'no_of_perfect_translations': ('django.db.models.fields.IntegerField', [], {}),
