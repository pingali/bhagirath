...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.logout_timestamp'
        db.alter_column('translation_session', 'logout_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Session.logout_timestamp'
        db.alter_column('translation_session', 'logout_timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 6, 14, 28, 9, 512537)))
