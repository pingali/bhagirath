...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Master_Experiment.bit_array'
        db.alter_column('translation_master_experiment', 'bit_array', self.gf('django.db.models.fields.CharField')(max_length=24))


    def backwards(self, orm):
        
        # Changing field 'Master_Experiment.bit_array'
        db.alter_column('translation_master_experiment', 'bit_array', self.gf('django.db.models.fields.IntegerField')())
