...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('translation_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default=u'Female', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.gender'
        db.delete_column('translation_userprofile', 'gender')
