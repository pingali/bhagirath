...
function GoogleTranslateClicked(btn, div) {
	if(btn.innerHTML == "View Translation from Google") {
		btn.innerHTML = "Hide Translation from Google";
	}
	else {
		btn.innerHTML = "View Translation from Google";
	}
	Animate(div);
}
